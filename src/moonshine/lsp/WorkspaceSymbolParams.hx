...
/**
	Implementation of `WorkspaceSymbolParams` interface from Language Server Protocol
	...
	**DO NOT** add new properties or methods to this class that are specific to
	...
	@see https://microsoft.github.io/language-server-protocol/specification#textDocument_workspaceSymbol
**/
