...
/**
	Implementation of `DeleteFile` interface from Language Server Protocol
...
@:structInit
class DeleteFile {
	public static final KIND:String = "delete";
	...
	**/
	...
	public static function parse(original:Dynamic):DeleteFile {
		var vo = new DeleteFile();
		vo.uri = original.uri;
		return vo;
	}
}
