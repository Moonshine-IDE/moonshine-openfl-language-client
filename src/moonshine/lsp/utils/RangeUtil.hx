...
class RangeUtil {
	...
	**/
	public static function rangesIntersect(r1:Range, r2:Range):Bool {
		...
		var resultEndLine = r1.end.line;
		var resultEndChar = r1.end.character;
		var otherStartLine = r2.start.line;
		var otherStartChar = r2.start.character;
		var otherEndLine = r2.end.line;
		var otherEndChar = r2.end.character;
