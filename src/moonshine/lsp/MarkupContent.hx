...
/**
	Implementation of `MarkupContent` interface from Language Server Protocol
...
class MarkupContent {
	...
	**/
	...
	public static function parse(original:Dynamic):MarkupContent {
		var vo = new MarkupContent();
		vo.kind = original.kind;
		vo.value = original.value;
		return vo;
	}
}
