...
/**
	Implementation of `ResponseMessage` interface from Language Server Protocol
	...
	**DO NOT** add new properties or methods to this class that are specific to
	...
	@see https://microsoft.github.io/language-server-protocol/specification#responseMessage
**/
typedef ResponseMessage = {
	> Message,
	id:Null<Any> /* Int | String */,
	?result:Any,
	?error:ResponseError,
}
